...
function gltheme_theme_customizer( $wp_customize ) {
	...
	*/
	...
	border-radius: 5px;
	padding: 5px;text-decoration: none;" href="https://wooskins.com/downloads/ws-cosmaty-free-responsive-cosmetic-store-woocommerce-wordpress-theme/" target="_blank" title="Get full website like demo with PRO version">' . __( 'Get PRO License', 'gltheme' ) . '</a>
